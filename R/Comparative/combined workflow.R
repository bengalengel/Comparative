...
phospho <- load.MQ(directory = "C:/Users/Brett/Documents/comparitive label free/single shot data//combined/txt/", type = "phospho")
# protein <- load.MQ(directory = "C:/Users/Brett/Documents/comparitive label free/single shot data//combined/txt/", type = "protein")
